...
<body>
  ...
  $sql = "SELECT leads.*, sales.nama, produk.nama 
          FROM leads 
          JOIN sales ON leads.id_sales = sales.id 
          JOIN produk ON leads.id_produk = produk.id";
  ...
  if (isset($_POST['search'])) {
      ...
      if (!empty($search_sales)) {
          $conditions[] = "sales.nama LIKE '%$search_sales%'";
      }
